...
public class ACMHatchPartMachine extends TieredPartMachine implements IMaintenanceMachine {
    ...
    private static final float MAX_DURATION_MULTIPLIER = 1 + (0.1F * (4 - GTEConfig.getDifficulty()));
    private static final float MIN_DURATION_MULTIPLIER = 1 - (0.1F * (4 - GTEConfig.getDifficulty()));
