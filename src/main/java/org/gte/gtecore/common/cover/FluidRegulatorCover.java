...
public final class FluidRegulatorCover extends ULVPumpCover {
    ...
    private static final int MAX_STACK_SIZE = 2_048_000_000;
    ...
    @Override
    protected int doTransferFluidsInternal(@NotNull IFluidHandlerModifiable source, @NotNull IFluidHandlerModifiable destination,
