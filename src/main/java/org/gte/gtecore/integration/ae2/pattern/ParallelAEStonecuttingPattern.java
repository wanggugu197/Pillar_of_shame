...
public final class ParallelAEStonecuttingPattern extends AEStonecuttingPattern {

    private final IInput[] input;
    private final GenericStack[] output;

    public ParallelAEStonecuttingPattern(AEItemKey definition, Level level, int parallel) {
