...
import static org.gte.gtecore.common.data.GTERecipeTypes.MANA_GARDEN_RECIPES;
...
public interface ManaSimulator {
    ...
    static void init() {
        ...
        MANA_GARDEN_RECIPES.recipeBuilder(GTECore.id("rosa_arcana"))
        ...
        MANA_GARDEN_RECIPES.recipeBuilder(GTECore.id("munchdew"))
